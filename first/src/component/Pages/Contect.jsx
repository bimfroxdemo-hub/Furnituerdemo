...
const Contact = () => {
  ...
  const whatsappNumber = "6353771878"; // apna WhatsApp number
    ...
    >
      ...
      <div
        ...
        className={`max-w-6xl w-full flex flex-col md:flex-row items-center justify-between 
                    ...
                    shadow-xl p-6 sm:p-10 lg:p-14 bg-zinc-100 dark:bg-zinc-800
      ...
      >
        ...
        {/* Text Section */}
        <div className="w-full md:w-2/3 text-center md:text-left px-4 order-2 md:order-none">
          <h2
            className={`text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 transition-all duration-700 
              ${animate ? "translate-x-0 opacity-100 text-zinc-900 dark:text-white" : "-translate-x-16 opacity-0"}`}
          >
            Why Connect With Us?
          </h2>
          <p
            className={`text-base sm:text-lg lg:text-xl leading-relaxed transition-all duration-1000 delay-300 
              ${animate ? "translate-x-0 opacity-100 text-zinc-800 dark:text-gray-300" : "-translate-x-16 opacity-0"}`}
          >
            ...
            provide real-time updates, and share the latest offers.
          </p>
      ...
      >
        {/* Image Section */}
        <div
          className={`w-full md:w-1/3 flex justify-center mb-6 md:mb-0 order-1 md:order-none
                      transition-all duration-1000 delay-200
                      ${animate ? "translate-x-0 opacity-100" : "translate-x-16 opacity-0"}`}
        >
          <img
        ...
        <div className="w-full md:w-2/3 text-center md:text-left px-4 order-2 md:order-none">
          <h3
            className={`text-xl sm:text-2xl lg:text-3xl font-bold mb-3 transition-all duration-700 
              ${animate ? "translate-x-0 opacity-100 text-zinc-900 dark:text-white" : "translate-x-16 opacity-0"}`}
          >
            24x7 WhatsApp Service
          </h3>
          <p
            className={`text-base sm:text-lg lg:text-xl text-zinc-700 dark:text-zinc-300 leading-relaxed transition-all duration-1000 delay-300 
              ${animate ? "translate-x-0 opacity-100" : "translate-x-16 opacity-0"}`}
          >
